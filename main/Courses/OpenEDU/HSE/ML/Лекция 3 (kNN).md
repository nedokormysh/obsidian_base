...
Не будем называть accuracy "точностью", точностью будем называть то, что в английском языке называется prestige", а вот и accuracy давайте переводить как долю верных ответов
